...
```{r}
LOGols_fitted_values %>%
  ggplot(aes(x = dep_log, y = .fitted)) +
  geom_point() +
  geom_smooth(method = "lm") +
  labs( x = "True log of depression score)", y = "Predicted log of depression score")
```
